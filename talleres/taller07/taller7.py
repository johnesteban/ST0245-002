...
class Lsimple():
    ...
    def insert(self, element, index):
        ...
        if index<0 or index>self.size: ##self.size, no puedo dejar la posicion 0 vacia e insertar en la 1??
    ...
    def remove(self, index):
        ...
        elif index==None: ##como hago con el None en la prueba
            index=self.size-1
            self.size-=1
        elif index==0:
...
class __main__():
    ...
    listas.insert(bee1,2) #Igual abeja en 2 pos diferentes?
    listas.remove(3)
    print(listas.contains(bee1))
    print(listas.contains(bee5))
    print(listas.contains(bee4))
    print(listas.contains(bee2))
